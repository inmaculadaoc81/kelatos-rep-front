...
/**
 * Botón "Enviar al cliente" para Ticket Manual (petición del usuario,
 * 2026-08-27) — proxy directo a POST .../tickets-manuales/:id/enviar
...
export async function POST(
  ...
  try {
    const resultado = await kelatosApiPost<{ ok: boolean; enviado: boolean; motivo?: string }>(
      `/v1/tickets-manuales/${encodeURIComponent(id)}/enviar`,
