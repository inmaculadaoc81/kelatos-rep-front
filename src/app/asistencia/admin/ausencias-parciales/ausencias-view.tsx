...
/** Ausencias parciales — misma tabla que Administración, con un modo
    `soloRemotos` para la sección Remote Work. */
export function AusenciasParcialesView({ soloRemotos = false }: { soloRemotos?: boolean }) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-lg font-semibold">{soloRemotos ? "Ausencias parciales — Remote Work" : "Ausencias parciales"}</h1>
