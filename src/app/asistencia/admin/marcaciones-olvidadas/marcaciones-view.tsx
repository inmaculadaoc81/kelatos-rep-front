...
/** Marcaciones olvidadas — misma tabla que Administración, con un modo
    `soloRemotos` para la sección Remote Work. */
export function MarcacionesOlvidadasView({ soloRemotos = false }: { soloRemotos?: boolean }) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-lg font-semibold">{soloRemotos ? "Marcaciones olvidadas — Remote Work" : "Marcaciones olvidadas"}</h1>
        <p className="text-xs text-muted-foreground">
          {soloRemotos
            ? "Solo empleados con un dispositivo remoto asignado. Al aprobar, tú escribes la entrada/salida del fichaje que falta."
