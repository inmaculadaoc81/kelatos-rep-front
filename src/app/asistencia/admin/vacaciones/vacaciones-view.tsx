...
/** Solicitudes de vacaciones — misma tabla que Administración, con un
    modo `soloRemotos` para la sección Remote Work (mismo patrón que
    FichajesView). */
export function VacacionesView({ soloRemotos = false }: { soloRemotos?: boolean }) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-lg font-semibold">{soloRemotos ? "Vacaciones — Remote Work" : "Vacaciones"}</h1>
