...
export const ArrowRight3 = withDefaults(Iconsax.ArrowRight3);
...
export const DocumentUpload = withDefaults(Iconsax.DocumentUpload);
...
export const Maximize4 = withDefaults(Iconsax.Maximize4);
export const MinusSquare = withDefaults(Iconsax.MinusSquare);
export const Sun1 = withDefaults(Iconsax.Sun1);
export const Moon = withDefaults(Iconsax.Moon);
...
export const Like1 = withDefaults(Iconsax.Like1);
export const Dislike = withDefaults(Iconsax.Dislike);
