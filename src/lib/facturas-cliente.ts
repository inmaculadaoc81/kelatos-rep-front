...
/** Columnas de reparaciones que usa la lista de facturas — se piden al backend
    (parámetro `columnas`) en vez de bajar las ~150 de la tabla, incluidos JSON
    enormes como lineas_ticket que aquí no se usan (~40 por ciento menos de
    datos por carga). El chequeo de tipos de abajo falla si la interfaz gana un
    campo que no está en esta lista. */
export const COLUMNAS_REPARACION_FACTURADA = [
  "resguardo",
  "cliente_nombre",
  "cliente_telefono",
  "cliente_email",
  ...
  "factura_borrador",
  "cliente_factura",
  "numero_factura_revision",
  "url_factura_revision",
  ...
  "numero_factura_mensajeria",
  "url_factura_mensajeria",
  "total_factura_mensajeria",
  "fecha_factura_mensajeria",
  "cliente_factura_mensajeria",
  "numero_ticket_mensajeria",
  "url_ticket_mensajeria",
  "fecha_ticket_mensajeria",
  ...
  "estado_factura_rectificativa",
  "numero_factura_rectificativa_revision",
  "url_factura_rectificativa_revision",
  "total_factura_rectificativa_revision",
  "fecha_factura_rectificativa_revision",
  "numero_factura_corregida",
  "url_factura_corregida",
  "total_factura_corregida",
  "fecha_factura_corregida",
  "numero_factura_corregida_revision",
  "url_factura_corregida_revision",
  "total_factura_corregida_revision",
  "fecha_factura_corregida_revision",
  "cliente_factura_corregida",
  "numero_ticket",
  "url_ticket",
  "fecha_ticket",
  "total_ticket",
  ...
  "total_ticket_rectificativa",
  "fecha_ticket_rectificativa",
  "motivo_ticket_rectificativa",
  "numero_ticket_corregida",
  "url_ticket_corregida",
  "total_ticket_corregida",
  "fecha_ticket_corregida",
  "estado_ticket_corregida",
  "numero_ticket_revision",
  "url_ticket_revision",
  "fecha_ticket_revision",
  "total_ticket_revision",
  "estado_ticket_revision",
  "forma_pago_ticket_revision",
  "banco_ticket_revision",
  "numero_ticket_revision_rectificativa",
  "url_ticket_revision_rectificativa",
  "total_ticket_revision_rectificativa",
  "fecha_ticket_revision_rectificativa",
  "numero_ticket_revision_corregida",
  "url_ticket_revision_corregida",
  "total_ticket_revision_corregida",
  "fecha_ticket_revision_corregida",
  "estado_ticket_revision_corregida",
] as const satisfies readonly (keyof FilaReparacionFacturadaSql)[];

type _ColumnasFaltantes = Exclude<keyof FilaReparacionFacturadaSql, (typeof COLUMNAS_REPARACION_FACTURADA)[number]>;
const _todasLasColumnasEstan: [_ColumnasFaltantes] extends [never] ? true : never = true;
void _todasLasColumnasEstan;
