...
export interface AgentStep {
  ...
  /** Forma distinta según el paso: array de empresas en discovery,
      {pasa,score} en cheap_pass, {calificado,analisis} en deep_analysis,
      null en message_writer — se castea en el punto de uso. */
  output: unknown;
  error: string | null;
