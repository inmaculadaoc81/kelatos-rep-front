...
export const config = {
  matcher: [
    ...
    "/((?!login|api/auth|api/mails/imagen|valoracion/|valoracion$|api/valoracion/|formulario|api/formulario-cliente|api/formulario-recogida|api/formulario-entrega-venta|_next/static|_next/image|favicon.ico|robots.txt|logos).*)",
  ],
};
